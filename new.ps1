...
Connect-AzAccount -SubscriptionId 3e16df7e-60cc-41c0-9fa3-a4a4176cf16b
 
# Create Report Array
$report = @()
# Record all the subscriptions in a Text file  
$SubscriptionIds = "3e16df7e-60cc-41c0-9fa3-a4a4176cf16b" 
Foreach ($SubscriptionId in $SubscriptionIds) 
{
$reportName = "mahesh.csv"
...
$report | Export-CSV "c:\output\$reportname"